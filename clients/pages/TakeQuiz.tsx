  ...
  if (isLoading || !quiz) {
    return (
      <div className="min-h-screen bg-white">
        ...
        <div className="h-28" />
        <div className="max-w-2xl mx-auto px-4 py-12">
          {isLoading ? <p className="text-gray-600">Loading quiz…</p> : <p className="text-gray-600">No quiz available for this course.</p>}
          <Link to={`/courses/${courseId}`} className="text-primary font-medium mt-2 inline-block">Back to course</Link>
        </div>
        <Footer />
      </div>
    );
