    ...
    return (
      <div className="bg-white rounded-[30px] shadow-sm border border-gray-200 p-6 sm:p-8">
        ...
        <p className="text-gray-600">
          Thank you for registering with KSOHTC. Your account is currently under review by our administration team. You will be able to access your courses once your registration has been approved. If you have already been approved, please log out and log in again to refresh your access.
        </p>
